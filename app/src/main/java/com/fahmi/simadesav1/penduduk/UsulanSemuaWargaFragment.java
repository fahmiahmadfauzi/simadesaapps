 ...
 */
public class UsulanSemuaWargaFragment extends Fragment {
    private static final String TAG = UsulanSemuaWargaFragment.class.getSimpleName();
    ...
    public UsulanSemuaWargaFragment() {
